...
- **[Pachyderm](https://github.com/pachyderm/pachyderm)** ![GitHub stars](https://img.shields.io/github/stars/pachyderm/pachyderm?style=social) - Data-centric pipelines and data versioning for MLOps. Immutable data lineage with automatic pipeline triggering on data changes. Kubernetes-native with parallel processing and autoscaling. Apache 2.0 licensed.
- **[Apache Burr](https://github.com/apache/burr)** ![GitHub stars](https://img.shields.io/github/stars/apache/burr?style=social) - Build stateful AI applications (chatbots, agents, simulations) with monitoring and persistence. Apache incubating project for decision-making applications with pluggable storage and observability. Apache 2.0 licensed.
- **[Covalent](https://github.com/AgnostiqHQ/covalent)** ![GitHub stars](https://img.shields.io/github/stars/AgnostiqHQ/covalent?style=social) - Pythonic workflow orchestration for ML, high-performance, and quantum computing. Execute functions on any cloud or on-prem cluster by changing a single decorator. Serverless infrastructure abstraction with 20+ executor plugins. Apache 2.0 licensed.
- **[Airbyte](https://github.com/airbytehq/airbyte)** ![GitHub stars](https://img.shields.io/github/stars/airbytehq/airbyte?style=social) - Leading data integration platform for ETL/ELT pipelines. 600+ connectors for APIs, databases, warehouses, and data lakes. Self-hosted and cloud options with no-code connector builder. MIT licensed.
- **[SQLFluff](https://github.com/sqlfluff/sqlfluff)** ![GitHub stars](https://img.shields.io/github/stars/sqlfluff/sqlfluff?style=social) - Modular SQL linter and auto-formatter for data pipelines. Supports 20+ SQL dialects and Jinja/dbt templating with auto-fix capabilities. Essential for maintaining SQL code quality in AI data workflows. MIT licensed.
...
- **[Laminar](https://github.com/lmnr-ai/lmnr)** ![GitHub stars](https://img.shields.io/github/stars/lmnr-ai/lmnr?style=social) - Open-source observability platform purpose-built for AI agents. YC S24. Features tracing, evals, AI monitoring with custom events, SQL access to data, and dashboards. Written in Rust for high performance. Apache 2.0 licensed.
...
- **[BAML (BoundaryML)](https://github.com/BoundaryML/baml)** ![GitHub stars](https://img.shields.io/github/stars/BoundaryML/baml?style=social) - Domain-specific language for generating structured outputs from LLMs with the best developer experience. Strongly-typed LLM functions with VSCode playground and built-in tracing. Multi-language support (Python, TypeScript, Ruby, Java, C#, Rust, Go). Apache 2.0 licensed.
