...
- **[ell](https://github.com/MadcowD/ell)** ![GitHub stars](https://img.shields.io/github/stars/MadcowD/ell?style=social) - Lightweight functional prompt engineering framework with automatic versioning and multimodal support. Language Model Programs (LMPs) treat prompts as encapsulated functions with built-in serialization and Ell Studio for prompt version control. MIT licensed.
- **[TextGrad](https://github.com/zou-group/textgrad)** ![GitHub stars](https://img.shields.io/github/stars/zou-group/textgrad?style=social) - Automatic "Differentiation" via Text using LLMs to backpropagate textual gradients. Published in Nature. PyTorch-like API for optimizing prompts and compound AI systems through textual feedback. MIT licensed.
