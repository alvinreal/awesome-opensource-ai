...
- **[Janus (DeepSeek)](https://github.com/deepseek-ai/Janus)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/Janus?style=social) - Unified multimodal understanding and generation model. Janus-Pro achieves state-of-the-art performance on both multimodal understanding and text-to-image generation tasks. MIT licensed.
- **[InternVL (OpenGVLab)](https://github.com/OpenGVLab/InternVL)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVL?style=social) - Advanced multimodal large language model series (InternVL3 released April 2025). GPT-4o level open-source alternative with superior vision-language performance. MIT licensed.
- **[OmniGen (VectorSpaceLab)](https://github.com/VectorSpaceLab/OmniGen)** ![GitHub stars](https://img.shields.io/github/stars/VectorSpaceLab/OmniGen?style=social) - Unified image generation model from multimodal prompts. Generates images from text, subject-driven inputs, identity-preserving references, and image conditioning without additional plugins. MIT licensed.
- **[LLaVA-NeXT (LLaVA-VL)](https://github.com/LLaVA-VL/LLaVA-NeXT)** ![GitHub stars](https://img.shields.io/github/stars/LLaVA-VL/LLaVA-NeXT?style=social) - Next-generation visual instruction tuning framework. Multimodal assistant built towards GPT-4V level capabilities with support for multiple images, video, and high-resolution inputs. Apache 2.0 licensed.
- **[MoE-LLaVA (PKU-YuanGroup)](https://github.com/PKU-YuanGroup/MoE-LLaVA)** ![GitHub stars](https://img.shields.io/github/stars/PKU-YuanGroup/MoE-LLaVA?style=social) - Mixture-of-Experts for Large Vision-Language Models. Sparse MoE architecture delivering superior multimodal performance with efficient parameter utilization. Apache 2.0 licensed, TMM 2025.
