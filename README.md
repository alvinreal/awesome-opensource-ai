...
- **[Voyager](https://github.com/spotify/voyager)** ![GitHub stars](https://img.shields.io/github/stars/spotify/voyager?style=social) - Fast approximate nearest-neighbor search library for Python and Java with zero dependencies. Production-tested at Spotify for millions of daily requests. Apache 2.0 licensed.
- **[hnswlib](https://github.com/nmslib/hnswlib)** ![GitHub stars](https://img.shields.io/github/stars/nmslib/hnswlib?style=social) - Header-only C++/Python library for fast approximate nearest neighbors using HNSW algorithm. Lightweight, efficient, and widely used as the foundation for many vector search implementations. Apache 2.0 licensed.
...
- **[ModelScope](https://github.com/modelscope/modelscope)** ![GitHub stars](https://img.shields.io/github/stars/modelscope/modelscope?style=social) - Alibaba's open-source Model-as-a-Service platform and model hub. The largest model community in China with 10,000+ models spanning CV, NLP, audio, and multimodal. Provides unified API for model discovery, download, and inference. Apache 2.0 licensed.
- **[ONNX Model Zoo](https://github.com/onnx/models)** ![GitHub stars](https://img.shields.io/github/stars/onnx/models?style=social) - Collection of pre-trained, state-of-the-art models in ONNX format. Sourced from prominent repositories (timm, torchvision, transformers) with standardized model signatures and validation tools for cross-platform deployment. Apache 2.0 licensed.
