...
- **[Goose](https://github.com/aaif-goose/goose)** ![GitHub stars](https://img.shields.io/github/stars/aaif-goose/goose?style=social) - Open-source extensible AI agent for code, workflows, and automation. Install, execute, edit, and test with any LLM. Desktop app, CLI, and API with MCP support. Now part of the Agentic AI Foundation at Linux Foundation. Apache 2.0 licensed.
- **[OpenCode](https://github.com/anomalyco/opencode)** ![GitHub stars](https://img.shields.io/github/stars/anomalyco/opencode?style=social) - The open source coding agent for terminal, IDE, and desktop. LSP integration, file change tracking, and external editor support. 140K+ stars, 850+ contributors. MIT licensed.
