...
- **[HuggingFace TGI](https://github.com/huggingface/text-generation-inference)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/text-generation-inference?style=social) - High-performance text generation inference server for LLMs. Optimized serving with continuous batching, FlashAttention, and Safetensors. Powers HuggingFace's inference API with production-grade throughput and latency. Apache 2.0 licensed.
...
- **[Kubeflow Model Registry](https://github.com/kubeflow/hub)** ![GitHub stars](https://img.shields.io/github/stars/kubeflow/hub?style=social) - Kubernetes-native model registry providing a single pane of glass for ML model developers. Manages models, versions, and ML artifacts metadata with UI and REST API. Fills the gap between experimentation and production in the MLOps lifecycle. Apache 2.0 licensed.
- **[KohakuHub](https://github.com/KohakuBlueleaf/KohakuHub)** ![GitHub stars](https://img.shields.io/github/stars/KohakuBlueleaf/KohakuHub?style=social) - Self-hosted HuggingFace alternative with Git-like versioning for AI models and datasets. Compatible with huggingface_hub Python client. Features LakeFS-powered branching/commits, S3 storage support, organizations, and web UI. AGPL-3.0 licensed.
