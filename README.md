...
- **[Refact](https://github.com/smallcloudai/refact)** ![GitHub stars](https://img.shields.io/github/stars/smallcloudai/refact?style=social) - Open-source AI agent that handles engineering tasks end-to-end. Ranked #1 on SWE-bench verified leaderboard with autonomous planning, execution, and integration with developer tools. BSD-3-Clause licensed.
