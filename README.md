...
- **[SenseVoice (FunAudioLLM)](https://github.com/FunAudioLLM/SenseVoice)** ![GitHub stars](https://img.shields.io/github/stars/FunAudioLLM/SenseVoice?style=social) - Multilingual voice understanding model with 400K+ hours training data. Supports 50+ languages with speech recognition, emotion recognition, and audio event detection. Surpasses Whisper performance on multiple benchmarks. MIT licensed.
- **[PaddleSpeech (Baidu)](https://github.com/PaddlePaddle/PaddleSpeech)** ![GitHub stars](https://img.shields.io/github/stars/PaddlePaddle/PaddleSpeech?style=social) - Easy-to-use speech toolkit with SOTA streaming ASR, TTS, speaker verification, and speech translation. Won NAACL 2022 Best Demo Award. Supports self-supervised learning models and end-to-end speech translation. Apache 2.0 licensed.
- **[FireRedASR (FireRedTeam)](https://github.com/FireRedTeam/FireRedASR)** ![GitHub stars](https://img.shields.io/github/stars/FireRedTeam/FireRedASR?style=social) - Industrial-grade ASR models supporting Mandarin, Chinese dialects and English. Achieves new SOTA on public Mandarin ASR benchmarks with outstanding singing lyrics recognition capability. Apache 2.0 licensed.
...
- **[Open-Sora (HPC-AI Tech)](https://github.com/hpcaitech/Open-Sora)** ![GitHub stars](https://img.shields.io/github/stars/hpcaitech/Open-Sora?style=social) - Democratizing efficient video production with fully open-source 11B video generation model. Achieves on-par performance with HunyuanVideo on VBench with training cost of only $200K. Apache 2.0 licensed.
- **[Helios (PKU Yuan Group)](https://github.com/PKU-YuanGroup/Helios)** ![GitHub stars](https://img.shields.io/github/stars/PKU-YuanGroup/Helios?style=social) - Real real-time long video generation model with efficient streaming architecture. Generates extended videos with temporal coherence and high quality. Apache 2.0 licensed.
