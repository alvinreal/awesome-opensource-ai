...
- **[Pezzo](https://github.com/pezzolabs/pezzo)** ![GitHub stars](https://img.shields.io/github/stars/pezzolabs/pezzo?style=social) - Cloud-native open-source LLMOps platform for prompt design, version management, collaboration, and observability. Features instant prompt delivery, cost optimization, and troubleshooting tools. Apache 2.0 licensed.
