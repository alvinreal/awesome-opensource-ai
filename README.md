...
- **[YOLO-World](https://github.com/AILab-CVC/YOLO-World)** ![GitHub stars](https://img.shields.io/github/stars/AILab-CVC/YOLO-World?style=social) - Real-time open-vocabulary object detection. Next-generation YOLO detector with strong open-vocabulary detection and grounding capabilities. Pre-trained on large-scale detection and image-text datasets with zero-shot inference. GPL-3.0 licensed.
- **[FastSAM](https://github.com/CASIA-IVA-Lab/FastSAM)** ![GitHub stars](https://img.shields.io/github/stars/CASIA-IVA-Lab/FastSAM?style=social) - Fast Segment Anything Model. CNN-based SAM alternative trained on 2% of SA-1B dataset achieving comparable performance at 50x higher runtime speed. Supports everything, text, box, and point prompt modes. Apache 2.0 licensed.
- **[MMDetection](https://github.com/open-mmlab/mmdetection)** ![GitHub stars](https://img.shields.io/github/stars/open-mmlab/mmdetection?style=social) - OpenMMLab Detection Toolbox and Benchmark. Modular PyTorch framework supporting object detection, instance segmentation, and panoptic segmentation with 300+ algorithms and 2000+ pre-trained models. Apache 2.0 licensed.
- **[MMSegmentation](https://github.com/open-mmlab/mmsegmentation)** ![GitHub stars](https://img.shields.io/github/stars/open-mmlab/mmsegmentation?style=social) - OpenMMLab Semantic Segmentation Toolbox. Unified benchmark for semantic segmentation with 50+ methods including PSPNet, DeepLabV3+, SegFormer, and Mask2Former. Apache 2.0 licensed.
