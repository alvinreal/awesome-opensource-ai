...
- **[GluonCV](https://github.com/dmlc/gluon-cv)** ![GitHub stars](https://img.shields.io/github/stars/dmlc/gluon-cv?style=social) - Gluon CV Toolkit providing state-of-the-art deep learning models for computer vision. 150+ pre-trained models for image classification, object detection, semantic segmentation, and pose estimation. Built on MXNet and PyTorch. Apache 2.0 licensed.
