...
- **[STORM (Stanford)](https://github.com/stanford-oval/storm)** ![GitHub stars](https://img.shields.io/github/stars/stanford-oval/storm?style=social) - LLM-powered knowledge curation system that generates Wikipedia-style articles with citations from search queries. MIT licensed.
