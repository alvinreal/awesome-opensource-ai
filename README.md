...
- **[LLaVA-OneVision-1.5](https://github.com/EvolvingLMMs-Lab/LLaVA-OneVision-1.5)** ![GitHub stars](https://img.shields.io/github/stars/EvolvingLMMs-Lab/LLaVA-OneVision-1.5?style=social) - Fully open multimodal training framework built on Megatron-LM. Supports MoE, FP8 precision, and long-sequence parallelism for efficient large-scale training. Includes open-source mid-training and instruct-tuning datasets via [LLaVA-OneVision-Data](https://huggingface.co/datasets/lmms-lab/LLaVA-OneVision-Data).
