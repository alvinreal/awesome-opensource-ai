...
- **[CleverHans](https://github.com/cleverhans-lab/cleverhans)** ![GitHub stars](https://img.shields.io/github/stars/cleverhans-lab/cleverhans?style=social) - Adversarial example library for constructing attacks, building defenses, and benchmarking both. From Google Brain researchers, widely used for benchmarking ML systems' vulnerability to adversarial examples. MIT licensed.
- **[Foolbox](https://github.com/bethgelab/foolbox)** ![GitHub stars](https://img.shields.io/github/stars/bethgelab/foolbox?style=social) - Python toolbox to create adversarial examples that fool neural networks. Native support for PyTorch, TensorFlow, and JAX with state-of-the-art gradient-based and gradient-free attacks. MIT licensed.
