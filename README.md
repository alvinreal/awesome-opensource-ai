...
- **[Quivr](https://github.com/QuivrHQ/quivr)** ![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/quivr?style=social) - Opinionated RAG framework for integrating GenAI into your apps. Focus on your product rather than the RAG. Works with any LLM (OpenAI, Anthropic, Mistral, etc.) and any file type. Easy integration with customization options. Apache 2.0 licensed.
...
- **[ChatGPT Retrieval Plugin](https://github.com/openai/chatgpt-retrieval-plugin)** ![GitHub stars](https://img.shields.io/github/stars/openai/chatgpt-retrieval-plugin?style=social) - OpenAI's standalone retrieval backend for semantic search and retrieval of personal or organizational documents. Flexible solution for building custom GPTs with document retrieval capabilities. MIT licensed.
