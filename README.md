...
- **[Verba (Weaviate)](https://github.com/weaviate/Verba)** ![GitHub stars](https://img.shields.io/github/stars/weaviate/Verba?style=social) - The Golden RAGtriever - end-to-end RAG chatbot powered by Weaviate. Combines state-of-the-art RAG techniques with Weaviate's context-aware database for querying and interacting with your data. BSD-3-Clause licensed.
- **[Khoj](https://github.com/khoj-ai/khoj)** ![GitHub stars](https://img.shields.io/github/stars/khoj-ai/khoj?style=social) - Your AI second brain. Self-hostable RAG platform to get answers from the web or your documents. Build custom agents, schedule automations, do deep research. Supports any LLM (local or cloud). AGPL-3.0 licensed.
- **[fastRAG (Intel)](https://github.com/IntelLabs/fastRAG)** ![GitHub stars](https://img.shields.io/github/stars/IntelLabs/fastRAG?style=social) - Efficient Retrieval Augmentation and Generation framework. Research framework for optimized RAG pipelines incorporating state-of-the-art LLMs with Intel hardware optimizations (Gaudi, OpenVINO). Apache 2.0 licensed.
