...
- **[InternVL (OpenGVLab)](https://github.com/OpenGVLab/InternVL)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVL?style=social) - [CVPR 2024 Oral] InternVL Family: A Pioneering Open-Source Alternative to GPT-4o. Large-scale multimodal model with 40B parameters for vision-language understanding, featuring strong OCR, chart comprehension, and cross-modal retrieval. MIT licensed.
- **[LLaVA-NeXT (LLaVA-VL)](https://github.com/LLaVA-VL/LLaVA-NeXT)** ![GitHub stars](https://img.shields.io/github/stars/LLaVA-VL/LLaVA-NeXT?style=social) - Next generation of LLaVA with improved reasoning, OCR, and world knowledge. State-of-the-art open-source vision-language model with enhanced instruction-following and visual grounding capabilities. Apache 2.0 licensed.
- **[InternVideo (OpenGVLab)](https://github.com/OpenGVLab/InternVideo)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVideo?style=social) - [ECCV 2024] Video foundation models for multimodal understanding. Features InternVid video-text dataset and InternVideo-Next with state-of-the-art performance on video retrieval, action recognition, and temporal grounding. Apache 2.0 licensed.
- **[Perception Models (Meta)](https://github.com/facebookresearch/perception_models)** ![GitHub stars](https://img.shields.io/github/stars/facebookresearch/perception_models?style=social) - State-of-the-art Image & Video CLIP and multimodal large language models from Meta. Includes PerceptionLM and PerceptionEncoder with strong performance on visual understanding benchmarks. Apache 2.0 licensed.
