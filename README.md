...
- **[Ploomber](https://github.com/ploomber/ploomber)** ![GitHub stars](https://img.shields.io/github/stars/ploomber/ploomber?style=social) - The fastest way to build data pipelines. Develop iteratively in Jupyter/VSCode, deploy anywhere (Kubernetes, Airflow, AWS Batch, SLURM). Automatically converts notebooks into modular, maintainable pipelines. Apache 2.0 licensed.
- **[Guild AI](https://github.com/guildai/guildai)** ![GitHub stars](https://img.shields.io/github/stars/guildai/guildai?style=social) - Experiment tracking and ML developer tools. Automates and optimizes ML experiments with grid search, random search, Bayesian optimization, and remote execution on cloud accelerators. Open source toolkit for reproducible ML.
- **[Meltano](https://github.com/meltano/meltano)** ![GitHub stars](https://img.shields.io/github/stars/meltano/meltano?style=social) - Declarative code-first data integration engine for data and ML-powered products. Extract, load, transform, and orchestrate data with 500+ connectors via Singer taps and targets. MIT licensed.
