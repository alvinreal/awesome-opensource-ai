...
- **[MiniMax-M1 (MiniMax AI)](https://github.com/MiniMax-AI/MiniMax-M1)** ![GitHub stars](https://img.shields.io/github/stars/MiniMax-AI/MiniMax-M1?style=social) - World's first open-weight, large-scale hybrid-attention reasoning model with 456B total / 45.9B active parameters. Apache 2.0 licensed with 1M context window and efficient MoE architecture.
- **[MiniMax-01 (MiniMax AI)](https://github.com/MiniMax-AI/MiniMax-01)** ![GitHub stars](https://img.shields.io/github/stars/MiniMax-AI/MiniMax-01?style=social) - MiniMax-Text-01 (456B/45.9B MoE) and MiniMax-VL-01 (vision-language) based on Linear Attention with 4M context window. MIT licensed with state-of-the-art long-context performance.
...
- **[Moshi (Kyutai)](https://github.com/kyutai-labs/moshi)** ![GitHub stars](https://img.shields.io/github/stars/kyutai-labs/moshi?style=social) - Speech-text foundation model and full-duplex spoken dialogue framework. Uses Mimi, a state-of-the-art streaming neural audio codec. Enables real-time conversational AI with natural turn-taking. Apache 2.0 licensed.
...
- **[Text Generation Inference (TGI)](https://github.com/huggingface/text-generation-inference)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/text-generation-inference?style=social) - Hugging Face's production-grade LLM serving toolkit. Powers the Hugging Face Inference API with support for Llama, Falcon, StarCoder, and 100+ models. Features continuous batching, token streaming, and safetensors integration. Apache 2.0 licensed.
...
- **[Bolt.diy](https://github.com/stackblitz-labs/bolt.diy)** ![GitHub stars](https://img.shields.io/github/stars/stackblitz-labs/bolt.diy?style=social) - Open-source AI web app builder. Prompt, run, edit, and deploy full-stack applications using any LLM. Self-hosted alternative to Bolt with full control over your data and models. MIT licensed.
- **[ShellGPT](https://github.com/TheR1D/shell_gpt)** ![GitHub stars](https://img.shields.io/github/stars/TheR1D/shell_gpt?style=social) - Command-line productivity tool powered by AI large language models. Generate shell commands, code snippets, and get answers to technical questions directly in your terminal. Supports multiple providers including local models via Ollama. MIT licensed.
- **[SocratiCode](https://github.com/giancarloerra/SocratiCode)** ![GitHub stars](https://img.shields.io/github/stars/giancarloerra/SocratiCode?style=social) - Enterprise-grade codebase intelligence platform with hybrid semantic search, polyglot dependency graphs, and symbol-level impact analysis. MCP server and plugins for Claude, Cursor, and other AI coding assistants. AGPL-3.0 licensed.
