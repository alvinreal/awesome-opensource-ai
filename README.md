...
- **[PyTorch3D](https://github.com/facebookresearch/pytorch3d)** ![GitHub stars](https://img.shields.io/github/stars/facebookresearch/pytorch3d?style=social) - FAIR's library of reusable components for deep learning with 3D data. Efficient operations on meshes, differentiable rendering, and implicit representations for 3D computer vision research. BSD-3-Clause licensed.
...
- **[OpenVLA](https://github.com/openvla/openvla)** ![GitHub stars](https://img.shields.io/github/stars/openvla/openvla?style=social) - Open-source vision-language-action model for robotic manipulation. Simple and scalable codebase for training and fine-tuning VLAs for generalist robotic control with SOTA performance. MIT licensed.
- **[ManiSkill](https://github.com/haosulab/ManiSkill)** ![GitHub stars](https://img.shields.io/github/stars/haosulab/ManiSkill?style=social) - SAPIEN Manipulation Skill Framework. GPU-parallelized robotics simulator and benchmark with 20+ task families, 2000+ diverse object models, and support for RL, imitation learning, and VLA models. Apache 2.0 licensed.
- **[Robosuite](https://github.com/ARISE-Initiative/robosuite)** ![GitHub stars](https://img.shields.io/github/stars/ARISE-Initiative/robosuite?style=social) - Modular simulation framework and benchmark for robot learning. MuJoCo-powered with standardized tasks, diverse robot embodiments including humanoids, and photo-realistic rendering. MIT licensed.
