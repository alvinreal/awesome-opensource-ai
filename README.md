...
- **[Quivr](https://github.com/QuivrHQ/quivr)** ![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/quivr?style=social) - Opinionated RAG framework for integrating GenAI into your applications. Works with any LLM (OpenAI, Anthropic, Mistral, etc.) and any file type (PDF, TXT, Markdown). Customizable with internet search and tool integrations. Apache 2.0 licensed.
- **[R2R](https://github.com/SciPhi-AI/R2R)** ![GitHub stars](https://img.shields.io/github/stars/SciPhi-AI/R2R?style=social) - State-of-the-art production-ready AI retrieval system with agentic RAG capabilities. Features multimodal content ingestion, hybrid search, knowledge graphs, and comprehensive document management with RESTful API. MIT licensed.
- **[Verba](https://github.com/weaviate/Verba)** ![GitHub stars](https://img.shields.io/github/stars/weaviate/Verba?style=social) - Golden RAGtriever - fully-customizable personal assistant for RAG out of the box. Built on Weaviate vector database with support for local (Ollama, HuggingFace) and cloud LLM providers. BSD-3-Clause licensed.
