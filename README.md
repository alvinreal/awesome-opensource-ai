...
- **[Feathr](https://github.com/feathr-ai/feathr)** ![GitHub stars](https://img.shields.io/github/stars/feathr-ai/feathr?style=social) - Enterprise-grade feature store from LinkedIn for data and AI engineering. Defines and manages features for ML models with offline/online storage, point-in-time correctness, and feature sharing across teams. Apache 2.0 licensed.
...
- **[whylogs](https://github.com/whylabs/whylogs)** ![GitHub stars](https://img.shields.io/github/stars/whylabs/whylogs?style=social) - Open-source standard for data logging in ML pipelines. Profiles data and model performance over time with privacy-preserving statistical summaries. Enables data quality monitoring and drift detection. Apache 2.0 licensed.
