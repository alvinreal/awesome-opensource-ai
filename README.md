...
- **[AI Engineering Hub (Akash Patil)](https://github.com/patchy631/ai-engineering-hub)** ![GitHub stars](https://img.shields.io/github/stars/patchy631/ai-engineering-hub?style=social) - 90+ production-ready tutorials on LLMs, RAG, and real-world AI agent applications. Covers beginner to advanced projects with CrewAI, LangGraph, AutoGen, and MCP. MIT licensed.
- **[Learn AI Engineering (Ashish Patel)](https://github.com/ashishps1/learn-ai-engineering)** ![GitHub stars](https://img.shields.io/github/stars/ashishps1/learn-ai-engineering?style=social) - Comprehensive roadmap for learning AI and LLMs from scratch. Curated free resources covering mathematics, ML, deep learning, LLMs, RAG, agents, and production deployment. GPL-3.0 licensed.
- **[LangChain Open Tutorial](https://github.com/LangChain-OpenTutorial/LangChain-OpenTutorial)** ![GitHub stars](https://img.shields.io/github/stars/LangChain-OpenTutorial/LangChain-OpenTutorial?style=social) - Community-driven comprehensive tutorials for LangChain and LangGraph. Beginner-friendly open tutorials covering RAG, agents, structured output, and production patterns. MIT licensed.
