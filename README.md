...
- **[GPT-Neo (EleutherAI)](https://github.com/EleutherAI/gpt-neo)** ![GitHub stars](https://img.shields.io/github/stars/EleutherAI/gpt-neo?style=social) - 1.3B and 2.7B parameter GPT-3-style models trained on the Pile. Historic milestone as one of the first open-source alternatives to GPT-3 with publicly available weights. MIT licensed.
- **[StableLM (Stability AI)](https://github.com/Stability-AI/StableLM)** ![GitHub stars](https://img.shields.io/github/stars/Stability-AI/StableLM?style=social) - Suite of open-source language models (3B to 7B parameters) trained on 1.5T tokens. Foundation for StableLM-tuned and subsequent Stability AI language models. Apache 2.0 licensed.
- **[Qwen3 (Alibaba)](https://github.com/QwenLM/Qwen3)** ![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen3?style=social) - State-of-the-art dense and MoE models (0.6B to 235B-A22B parameters) with seamless thinking/non-thinking modes. 256K context window, 100+ languages, and advanced agentic capabilities. Apache 2.0 licensed.
- **[Petals (BigScience)](https://github.com/bigscience-workshop/petals)** ![GitHub stars](https://img.shields.io/github/stars/bigscience-workshop/petals?style=social) - Distributed inference for large language models. Run BLOOM-176B and other massive models collaboratively by joining compute resources with other users. Decentralized LLM serving network. MIT licensed.
- **[OPT (Meta)](https://github.com/facebookresearch/metaseq)** ![GitHub stars](https://img.shields.io/github/stars/facebookresearch/metaseq?style=social) - Open Pre-trained Transformer language models (125M to 175B parameters). Full training codebase and model weights released for reproducibility. One of the first truly open large language models from a major AI lab. MIT licensed.
...
- **[Text Generation Inference (TGI)](https://github.com/huggingface/text-generation-inference)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/text-generation-inference?style=social) - Hugging Face's production-grade inference toolkit. Powers Hugging Chat, Inference API, and Inference Endpoints with tensor parallelism and dynamic batching for Llama, Falcon, StarCoder, BLOOM, GPT-NeoX, and T5. Apache 2.0 licensed.
