...
- **[MegaParse (Quivr)](https://github.com/QuivrHQ/MegaParse)** ![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/MegaParse?style=social) - File parser optimised for LLM Ingestion with no loss. Parse PDFs, Docx, PPTx in a format that is ideal for LLMs. Apache 2.0 licensed.
- **[liteparse (LlamaIndex)](https://github.com/run-llama/liteparse)** ![GitHub stars](https://img.shields.io/github/stars/run-llama/liteparse?style=social) - Fast, helpful, and open-source document parser. Standalone PDF parsing tool focused exclusively on fast and light parsing with high-quality spatial text parsing and bounding boxes. Apache 2.0 licensed.
- **[open-parse](https://github.com/Filimoa/open-parse)** ![GitHub stars](https://img.shields.io/github/stars/Filimoa/open-parse?style=social) - Improved file parsing for LLMs. Better semantic chunking for complex documents. MIT licensed.
- **[OCRmyPDF](https://github.com/ocrmypdf/OCRmyPDF)** ![GitHub stars](https://img.shields.io/github/stars/ocrmypdf/OCRmyPDF?style=social) - Adds an OCR text layer to scanned PDF files, allowing them to be searched. Production-ready tool with support for over 100 languages. MPL-2.0 licensed.
- **[GROBID](https://github.com/kermitt2/grobid)** ![GitHub stars](https://img.shields.io/github/stars/kermitt2/grobid?style=social) - Machine learning library for extracting, parsing and re-structuring raw documents such as PDF into structured XML/TEI encoded documents. Focus on technical and scientific publications. Apache 2.0 licensed.
