...
- **[GPT-Researcher](https://github.com/assafelovic/gpt-researcher)** ![GitHub stars](https://img.shields.io/github/stars/assafelovic/gpt-researcher?style=social) - Autonomous agent that conducts deep research on any data using any LLM providers. Generates comprehensive reports with citations. Apache 2.0 licensed.
- **[Superagent](https://github.com/superagent-ai/superagent)** ![GitHub stars](https://img.shields.io/github/stars/superagent-ai/superagent?style=social) - Runtime protection for AI agents and copilots. Guards against prompt injections, data leaks, and harmful outputs with real-time inspection and threat blocking. MIT licensed.
- **[AgentQL](https://github.com/tinyfish-io/agentql)** ![GitHub stars](https://img.shields.io/github/stars/tinyfish-io/agentql?style=social) - Query language and Playwright integrations for connecting AI to the web. Extract structured data and interact with web elements quickly, precisely, and at scale. MIT licensed.
- **[ReactAgent](https://github.com/eylonmiz/react-agent)** ![GitHub stars](https://img.shields.io/github/stars/eylonmiz/react-agent?style=social) - Autonomous agent that generates and composes React components from user stories using GPT-4. Built with React, TailwindCSS, TypeScript, and Radix UI. MIT licensed.
- **[KaibanJS](https://github.com/kaiban-ai/KaibanJS)** ![GitHub stars](https://img.shields.io/github/stars/kaiban-ai/KaibanJS?style=social) - JavaScript-native framework for building and managing multi-agent systems with a Kanban-inspired approach. MIT licensed.
