...
- **[Qwen2.5-Omni (Alibaba)](https://github.com/QwenLM/Qwen2.5-Omni)** ![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen2.5-Omni?style=social) - End-to-end multimodal model capable of understanding text, audio, vision, video, and performing real-time speech generation. Features Thinker-Talker architecture with TMRoPE for synchronized timestamp alignment. Apache 2.0 licensed.
- **[LLaVA-NeXT](https://github.com/LLaVA-VL/LLaVA-NeXT)** ![GitHub stars](https://img.shields.io/github/stars/LLaVA-VL/LLaVA-NeXT?style=social) - Improved vision-language model with stronger reasoning, OCR, and world knowledge. Supports multi-image, video, and 3D understanding with LLaVA-OneVision models achieving state-of-the-art performance.
- **[Video-LLaVA (PKU)](https://github.com/PKU-YuanGroup/Video-LLaVA)** ![GitHub stars](https://img.shields.io/github/stars/PKU-YuanGroup/Video-LLaVA?style=social) - Unified visual representation learning for video understanding by alignment before projection. Enables LLMs to perform visual reasoning on both images and videos simultaneously. EMNLP 2024. Apache 2.0 licensed.
- **[Macaw-LLM](https://github.com/lyuchenyang/Macaw-LLM)** ![GitHub stars](https://img.shields.io/github/stars/lyuchenyang/Macaw-LLM?style=social) - Multi-modal language modeling with image, video, audio, and text integration. Built on CLIP, Whisper, and LLaMA with simple alignment strategy for seamless multi-modal fusion.
- **[Janus (DeepSeek)](https://github.com/deepseek-ai/Janus)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/Janus?style=social) - Unified multimodal understanding and generation models including Janus-Pro for advanced visual understanding and generation. MIT licensed.
- **[InternVL (OpenGVLab)](https://github.com/OpenGVLab/InternVL)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVL?style=social) - A pioneering open-source alternative to GPT-4o. CVPR 2024 Oral. Family of vision-language models with state-of-the-art performance on multimodal tasks. MIT licensed.
- **[OpenVLA](https://github.com/openvla/openvla)** ![GitHub stars](https://img.shields.io/github/stars/openvla/openvla?style=social) - Open-source vision-language-action model for robotic manipulation. 7B-parameter model trained on 970k real-world robot demonstrations. MIT licensed.
...
- **[Wav2Lip](https://github.com/Rudrabha/Wav2Lip)** ![GitHub stars](https://img.shields.io/github/stars/Rudrabha/Wav2Lip?style=social) - Highly accurate lip-sync generation for speech-to-lip generation in the wild. Synchronizes lip movements to match target audio with high accuracy for any identity, voice, and language. ACM Multimedia 2020.
...
- **[PINTO Model Zoo](https://github.com/PINTO0309/PINTO_model_zoo)** ![GitHub stars](https://img.shields.io/github/stars/PINTO0309/PINTO_model_zoo?style=social) - Comprehensive repository of 400+ inter-converted deep learning models spanning 200+ use cases. Supports TensorFlow, PyTorch, ONNX, OpenVINO, TensorFlowJS, TensorFlowLite, EdgeTPU, and CoreML formats. Essential resource for edge AI deployment and cross-framework model conversion. MIT licensed.
...
- **[Phoenix (Arize)](https://github.com/Arize-ai/phoenix)** ![GitHub stars](https://img.shields.io/github/stars/Arize-ai/phoenix?style=social) - Open-source AI observability and evaluation platform. Trace LLM applications, run experiments, evaluate prompts, and manage datasets with LLM-as-a-judge scoring. Integrates with OpenTelemetry, LangChain, LlamaIndex, and major LLM providers. Apache 2.0 licensed.
- **[Langfuse](https://github.com/langfuse/langfuse)** ![GitHub stars](https://img.shields.io/github/stars/langfuse/langfuse?style=social) - Open-source LLM engineering platform with observability, metrics, evals, prompt management, and datasets. Self-hostable with OpenTelemetry integration and LLM-as-a-judge capabilities. MIT licensed.
- **[Evidently](https://github.com/evidentlyai/evidently)** ![GitHub stars](https://img.shields.io/github/stars/evidentlyai/evidently?style=social) - Open-source ML and LLM observability framework. 100+ built-in metrics for evaluating, testing, and monitoring AI systems from tabular data to Gen AI. Apache 2.0 licensed.
...
- **[Twinny](https://github.com/twinnydotdev/twinny)** ![GitHub stars](https://img.shields.io/github/stars/twinnydotdev/twinny?style=social) - Free AI code completion plugin for VS Code. Supports local (Ollama) and API-hosted models. Privacy-focused alternative to GitHub Copilot with chat and completion features. MIT licensed.
...
- **[Zasper](https://github.com/zasper-io/zasper)** ![GitHub stars](https://img.shields.io/github/stars/zasper-io/zasper?style=social) - High-performance IDE for Jupyter Notebooks built in Go. Uses 1/4 the RAM and CPU of JupyterLab with Go coroutines for kernel management. AGPL-3.0 licensed.
...
- **[llm.nvim](https://github.com/huggingface/llm.nvim)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/llm.nvim?style=social) - LLM-powered development for Neovim. Ghost text code completions powered by llm-ls with support for Hugging Face models and local LLMs. Apache 2.0 licensed.
