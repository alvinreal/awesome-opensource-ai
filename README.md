...
- **[Guardrails AI](https://github.com/guardrails-ai/guardrails)** ![GitHub stars](https://img.shields.io/github/stars/guardrails-ai/guardrails?style=social) - Adding guardrails to large language models. Framework for validating, correcting, and controlling LLM outputs with 50+ built-in validators for PII detection, toxic content, prompt injection prevention, and custom validation rules. Apache 2.0 licensed.
- **[TextAttack](https://github.com/QData/TextAttack)** ![GitHub stars](https://img.shields.io/github/stars/QData/TextAttack?style=social) - Python framework for adversarial attacks, data augmentation, and model training in NLP. Generate adversarial examples to test model robustness, benchmark vulnerability, and improve model security through adversarial training. MIT licensed.
