...
- **[h2oGPT](https://github.com/h2oai/h2ogpt)** ![GitHub stars](https://img.shields.io/github/stars/h2oai/h2ogpt?style=social) - Private chat with local GPT supporting documents, images, and video. 100% private, Apache 2.0. Supports Ollama, Mixtral, llama.cpp backends with voice TTS, voice cloning, and bake-off UI mode for comparing multiple models simultaneously.
- **[Lorax](https://github.com/predibase/lorax)** ![GitHub stars](https://img.shields.io/github/stars/predibase/lorax?style=social) - Multi-LoRA inference server that scales to 1000s of fine-tuned LLMs. Serve multiple adapters on a single base model with dynamic adapter loading and efficient GPU memory management. Apache 2.0 licensed.
