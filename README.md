...
- **[XNNPACK](https://github.com/google/XNNPACK)** ![GitHub stars](https://img.shields.io/github/stars/google/XNNPACK?style=social) - High-efficiency floating-point neural network inference operators for mobile, server, and Web. Powers TensorFlow Lite, PyTorch, ONNX Runtime, and MediaPipe. BSD licensed.
- **[ncnn](https://github.com/Tencent/ncnn)** ![GitHub stars](https://img.shields.io/github/stars/Tencent/ncnn?style=social) - High-performance neural network inference framework optimized for mobile platforms. Cross-platform with no third-party dependencies, runs faster than other mobile frameworks. Powers QQ, WeChat, and Qzone. BSD-3-Clause licensed.
- **[MNN](https://github.com/alibaba/MNN)** ![GitHub stars](https://img.shields.io/github/stars/alibaba/MNN?style=social) - Blazing-fast, lightweight inference engine battle-tested by Alibaba. Supports inference and training on-device with industry-leading performance. Powers 30+ apps including Taobao and Tmall. Apache 2.0 licensed.
