...
- **[DeepSpeed-MII](https://github.com/deepspeedai/DeepSpeed-MII)** ![GitHub stars](https://img.shields.io/github/stars/deepspeedai/DeepSpeed-MII?style=social) - Microsoft's low-latency and high-throughput inference engine powered by DeepSpeed. Accelerated text-generation inference with optimized CUDA kernels, dynamic batching, and support for text-to-image models like Stable Diffusion. Apache 2.0 licensed.
