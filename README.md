...
- **[LLaVA (Haotian Liu)](https://github.com/haotian-liu/LLaVA)** ![GitHub stars](https://img.shields.io/github/stars/haotian-liu/LLaVA?style=social) - Visual Instruction Tuning framework built towards GPT-4V level capabilities. NeurIPS 2023 Oral. Large language and vision model with visual instruction following. Apache 2.0 licensed.
- **[Qwen-VL (Alibaba)](https://github.com/QwenLM/Qwen-VL)** ![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen-VL?style=social) - Large vision language model from Alibaba Cloud. Pretrained chat model with strong performance on multimodal benchmarks including MME, MMBench, and SEED-Bench. Apache 2.0 licensed.
- **[Video-LLaVA (PKU-YuanGroup)](https://github.com/PKU-YuanGroup/Video-LLaVA)** ![GitHub stars](https://img.shields.io/github/stars/PKU-YuanGroup/Video-LLaVA?style=social) - Learning United Visual Representation by Alignment Before Projection. EMNLP 2024. Unified video-language understanding with strong zero-shot performance on video question answering. Apache 2.0 licensed.
- **[InternVideo (OpenGVLab)](https://github.com/OpenGVLab/InternVideo)** ![GitHub stars](https://img.shields.io/github/stars/OpenGVLab/InternVideo?style=social) - Video Foundation Models and Data for Multimodal Understanding. ECCV 2024. Scalable video foundation models for multimodal video understanding with InternVideo2 and InternVideo2.5 series. Apache 2.0 licensed.
...
- **[Sacred](https://github.com/IDSIA/sacred)** ![GitHub stars](https://img.shields.io/github/stars/IDSIA/sacred?style=social) - Python tool to configure, organize, log and reproduce computational experiments. Config scopes, command-line interface, and MongoDB observers for experiment management. MIT licensed.
...
- **[NannyML](https://github.com/NannyML/nannyml)** ![GitHub stars](https://img.shields.io/github/stars/NannyML/nannyml?style=social) - Post-deployment ML monitoring with performance estimation without ground truth. Detects data drift and intelligently links drift alerts to model performance changes. Apache 2.0 licensed.
- **[whylogs](https://github.com/whylabs/whylogs)** ![GitHub stars](https://img.shields.io/github/stars/whylabs/whylogs?style=social) - Open-source data logging library for ML models and data pipelines. Privacy-preserving data profiling with statistical summaries for data quality and model performance monitoring. Apache 2.0 licensed.
- **[Alibi Detect](https://github.com/SeldonIO/alibi-detect)** ![GitHub stars](https://img.shields.io/github/stars/SeldonIO/alibi-detect?style=social) - Python library for outlier, adversarial and drift detection. Online and offline detectors for tabular data, text, images and time series from Seldon. Apache 2.0 licensed.
