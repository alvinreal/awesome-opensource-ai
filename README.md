...
- **[TEN Framework](https://github.com/TEN-framework/ten-framework)** ![GitHub stars](https://img.shields.io/github/stars/TEN-framework/ten-framework?style=social) - Open-source framework for real-time multimodal conversational AI agents with voice, vision, and avatar support. Apache 2.0 licensed.
