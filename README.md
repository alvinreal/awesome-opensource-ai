...
- **[Qwen3.6 (Alibaba)](https://github.com/QwenLM/Qwen3.6)** ![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen3.6?style=social) - Latest flagship series released April 2026 with 1M context window, agentic coding performance competitive with Claude 4.5 Opus, and enhanced multimodal capabilities. Apache 2.0 licensed.
- **[Qwen3-Omni (Alibaba)](https://github.com/QwenLM/Qwen3-Omni)** ![GitHub stars](https://img.shields.io/github/stars/QwenLM/Qwen3-Omni?style=social) - Natively end-to-end omni-modal LLM capable of understanding text, audio, images, and video, while generating real-time streaming speech. Achieves SOTA on 32 of 36 audio/audio-visual benchmarks. Apache 2.0 licensed.
- **[DeepSeek-V3.2-Exp (DeepSeek)](https://github.com/deepseek-ai/DeepSeek-V3.2-Exp)** ![GitHub stars](https://img.shields.io/github/stars/deepseek-ai/DeepSeek-V3.2-Exp?style=social) - Experimental release with DeepSeek Sparse Attention (DSA) for improved training and inference efficiency. Intermediate step toward next-generation architecture with performance on par with V3.1-Terminus.
...
- **[MLC LLM](https://github.com/mlc-ai/mlc-llm)** ![GitHub stars](https://img.shields.io/github/stars/mlc-ai/mlc-llm?style=social) - Universal LLM Deployment Engine with ML Compilation. High-performance inference engine compiling and running LLMs across AMD, NVIDIA, Apple, Intel GPUs, web browsers (WebGPU/WASM), iOS, and Android. Apache 2.0 licensed.
- **[WebLLM](https://github.com/mlc-ai/web-llm)** ![GitHub stars](https://img.shields.io/github/stars/mlc-ai/web-llm?style=social) - High-performance In-browser LLM Inference Engine. Brings language model inference directly onto web browsers with WebGPU hardware acceleration—everything runs inside the browser with no server support. Apache 2.0 licensed.
