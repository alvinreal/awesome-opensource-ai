...
- **[DeepSpeed-MII](https://github.com/deepspeedai/DeepSpeed-MII)** ![GitHub stars](https://img.shields.io/github/stars/deepspeedai/DeepSpeed-MII?style=social) - Microsoft's high-throughput inference engine with blocked KV-caching, continuous batching, and Dynamic SplitFuse. Delivers up to 2.5x higher throughput than vLLM for Llama-2-70B and Mixtral MoE models. Apache 2.0 licensed.
...
- **[gpt-fast](https://github.com/pytorch-labs/gpt-fast)** ![GitHub stars](https://img.shields.io/github/stars/pytorch-labs/gpt-fast?style=social) - Simple and efficient PyTorch-native transformer text generation in <1000 lines of Python. Features int8/int4 quantization, speculative decoding, and tensor parallelism for Nvidia/AMD GPUs. BSD-3-Clause licensed.
- **[S-LoRA](https://github.com/S-LoRA/S-LoRA)** ![GitHub stars](https://img.shields.io/github/stars/S-LoRA/S-LoRA?style=social) - Serving thousands of concurrent LoRA adapters on a single GPU with efficient memory management and dynamic adapter loading. Scales LoRA serving to 1000+ adapters with minimal overhead. Apache 2.0 licensed.
- **[Punica](https://github.com/punica-ai/punica)** ![GitHub stars](https://img.shields.io/github/stars/punica-ai/punica?style=social) - Multi-tenant LoRA serving system that serves multiple LoRA-finetuned LLMs as one. Enables efficient batching across different LoRA adapters for cost-effective fine-tuned model deployment. Apache 2.0 licensed.
...
- **[Marlin](https://github.com/IST-DASLab/marlin)** ![GitHub stars](https://img.shields.io/github/stars/IST-DASLab/marlin?style=social) - Mixed Auto-Regressive Linear kernel for FP16xINT4 matmul. Achieves near-ideal 4x speedups up to batch sizes of 16-32 tokens, making it ideal for larger-scale serving and speculative decoding. Apache 2.0 licensed.
