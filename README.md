...
- **[FLUX.2 (Black Forest Labs)](https://github.com/black-forest-labs/flux2)** ![GitHub stars](https://img.shields.io/github/stars/black-forest-labs/flux2?style=social) - Official inference repo for FLUX.2 state-of-the-art image generation and editing models. Includes 4B and 9B parameter models with text-to-image, single-reference editing, and multi-reference generation capabilities. Apache 2.0 licensed (4B models).
- **[IOPaint](https://github.com/Sanster/IOPaint)** ![GitHub stars](https://img.shields.io/github/stars/Sanster/IOPaint?style=social) - Free, open-source inpainting and outpainting tool powered by SOTA AI models. Remove unwanted objects, defects, or people from images; erase and replace anything using stable diffusion. Fully self-hostable with local and hosted workflows. Apache 2.0 licensed.
...
- **[TRELLIS.2 (Microsoft)](https://github.com/microsoft/TRELLIS.2)** ![GitHub stars](https://img.shields.io/github/stars/microsoft/TRELLIS.2?style=social) - Next-generation 3D generation with native and compact structured latents. TRELLIS.2-4B model delivers improved quality and efficiency for 3D asset creation from images. MIT licensed.
