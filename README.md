...
- **[DeepVariant](https://github.com/google/deepvariant)** ![GitHub stars](https://img.shields.io/github/stars/google/deepvariant?style=social) - Deep learning-based variant caller that uses convolutional neural networks to call genetic variants from next-generation DNA sequencing data. Google's production-grade genomics analysis pipeline. BSD-3-Clause licensed.
- **[OpenMM](https://github.com/openmm/openmm)** ![GitHub stars](https://img.shields.io/github/stars/openmm/openmm?style=social) - High-performance toolkit for molecular simulation using GPU acceleration. Extreme flexibility through custom forces and integrators with support for AMBER, CHARMM, and AMOEBA force fields. MIT and LGPL licensed.
- **[RDKit](https://github.com/rdkit/rdkit)** ![GitHub stars](https://img.shields.io/github/stars/rdkit/rdkit?style=social) - Collection of cheminformatics and machine-learning software for molecular operations, descriptor generation, and fingerprinting. Industry-standard toolkit for computational chemistry with PostgreSQL cartridge for substructure and similarity searches. BSD-3-Clause licensed.
...
- **[Nilearn](https://github.com/nilearn/nilearn)** ![GitHub stars](https://img.shields.io/github/stars/nilearn/nilearn?style=social) - Python library for fast and easy statistical learning on neuroimaging (fMRI, sMRI) data. Comprehensive machine learning and visualization tools for brain imaging analysis. BSD-3-Clause licensed.
