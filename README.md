...
- **[Quivr](https://github.com/QuivrHQ/quivr)** ![GitHub stars](https://img.shields.io/github/stars/QuivrHQ/quivr?style=social) - Opiniated RAG framework for integrating GenAI in your apps. Works with any LLM (OpenAI, Anthropic, Mistral, etc.) and any vector store (PGVector, Faiss). Focus on your product rather than the RAG infrastructure. Apache 2.0 licensed.
...
- **[STORM (Stanford)](https://github.com/stanford-oval/storm)** ![GitHub stars](https://img.shields.io/github/stars/stanford-oval/storm?style=social) - LLM-powered knowledge curation system that researches a topic and generates full-length reports with citations. Research-oriented RAG framework from Stanford OVAL lab. MIT licensed.
...
- **[Cognita (TrueFoundry)](https://github.com/truefoundry/cognita)** ![GitHub stars](https://img.shields.io/github/stars/truefoundry/cognita?style=social) - Modular RAG framework for building production-ready open-source applications. End-to-end platform with built-in monitoring, observability, model versioning and experiment tracking. Apache 2.0 licensed.
...
- **[Verba (Weaviate)](https://github.com/weaviate/Verba)** ![GitHub stars](https://img.shields.io/github/stars/weaviate/Verba?style=social) - The Golden RAGtriever - end-to-end streamlined RAG application with user-friendly interface. Works locally with Ollama/HuggingFace or via API providers (OpenAI, Anthropic, Cohere). Built on Weaviate vector database. BSD-3-Clause licensed.
