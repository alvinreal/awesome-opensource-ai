...
- **[AI-Infra-Guard (Tencent)](https://github.com/Tencent/AI-Infra-Guard)** ![GitHub stars](https://img.shields.io/github/stars/Tencent/AI-Infra-Guard?style=social) - Full-stack AI Red Teaming platform securing AI ecosystems via OpenClaw Security Scan, Agent Scan, Skills Scan, MCP scan, AI Infra scan and LLM jailbreak evaluation. Detects 1000+ CVEs across 57+ AI components. Apache 2.0 licensed.
- **[FuzzyAI (CyberArk)](https://github.com/cyberark/FuzzyAI)** ![GitHub stars](https://img.shields.io/github/stars/cyberark/FuzzyAI?style=social) - Powerful tool for automated LLM fuzzing to identify and mitigate jailbreaks. Supports 15+ attack methods including ArtPrompt, PAIR, Crescendo, and genetic algorithms. Apache 2.0 licensed.
