...
- **[PowerInfer](https://github.com/SJTU-IPADS/PowerInfer)** ![GitHub stars](https://img.shields.io/github/stars/SJTU-IPADS/PowerInfer?style=social) - High-speed LLM inference engine for consumer-grade GPUs. Achieves up to 11x faster generation on local machines by exploiting neuron locality through adaptive prediction and neuron-aware sparse inference. MIT licensed.
- **[DeepSpeed-MII](https://github.com/deepspeedai/DeepSpeed-MII)** ![GitHub stars](https://img.shields.io/github/stars/deepspeedai/DeepSpeed-MII?style=social) - Microsoft's MII (Model Inference Infrastructure) makes low-latency and high-throughput inference possible, powered by DeepSpeed. Features DeepSpeed-FastGen for up to 2.5x throughput improvement over vLLM. Apache 2.0 licensed.
- **[CTranslate2](https://github.com/OpenNMT/CTranslate2)** ![GitHub stars](https://img.shields.io/github/stars/OpenNMT/CTranslate2?style=social) - Fast inference engine for Transformer models with custom kernels for CPU and GPU. Implements advanced optimizations including layer fusion, quantization, and batch reordering for efficient production serving. MIT licensed.
- **[LoRAX](https://github.com/predibase/lorax)** ![GitHub stars](https://img.shields.io/github/stars/predibase/lorax?style=social) - Multi-LoRA inference server that scales to thousands of fine-tuned LLMs on a single GPU. Enables serving many specialized model variants without the memory overhead of loading each base model separately. Apache 2.0 licensed.
- **[Text Generation Inference (TGI)](https://github.com/huggingface/text-generation-inference)** ![GitHub stars](https://img.shields.io/github/stars/huggingface/text-generation-inference?style=social) - Hugging Face's production-grade serving toolkit for LLMs. Powers HuggingChat and the Inference API with optimized batching, continuous batching, and flash attention support. Apache 2.0 licensed.
