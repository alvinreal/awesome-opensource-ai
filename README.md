...
- **[Search-R1](https://github.com/PeterGriffinJin/Search-R1)** ![GitHub stars](https://img.shields.io/github/stars/PeterGriffinJin/Search-R1?style=social) - RL training framework for reasoning-and-searching interleaved LLMs. Trains models to make coordinated tool calls to search engines while reasoning, supporting PPO, GRPO, and REINFORCE++ with vLLM integration. Apache 2.0 licensed.
- **[RAGEN](https://github.com/RAGEN-AI/RAGEN)** ![GitHub stars](https://img.shields.io/github/stars/RAGEN-AI/RAGEN?style=social) - Reinforcement learning framework for training LLM reasoning agents in interactive, stochastic environments. Specializes in agentic workflows with search-augmented reasoning and multi-turn decision making. MIT licensed.
...
- **[ROLL (Alibaba)](https://github.com/alibaba/ROLL)** ![GitHub stars](https://img.shields.io/github/stars/alibaba/ROLL?style=social) - Efficient and user-friendly scaling library for reinforcement learning with large language models. Supports multi-task RL training across mathematics, coding, reasoning, and open-ended Q&A with flexible domain distribution control. Apache 2.0 licensed.
