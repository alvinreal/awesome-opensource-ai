...
- **[MAX (Modular)](https://github.com/modular/modular)** ![GitHub stars](https://img.shields.io/github/stars/modular/modular?style=social) - High-performance inference framework and AI development platform. Includes MAX inference server with OpenAI-compatible API, Mojo programming language, and 450K+ lines of open-source GPU/CPU kernels. Unified compute layer across NVIDIA, AMD, and Apple Silicon. Apache 2.0 with LLVM Exceptions licensed.
...
- **[BitNet](https://github.com/microsoft/BitNet)** ![GitHub stars](https://img.shields.io/github/stars/microsoft/BitNet?style=social) - Official inference framework for 1-bit LLMs (BitNet b1.58). Optimized kernels for fast and lossless inference of 1.58-bit models on CPU and GPU. Achieves 1.37x to 6.17x speedups with 55-82% energy reduction. Can run 100B parameter models on a single CPU. MIT licensed.
- **[exo](https://github.com/exo-explore/exo)** ![GitHub stars](https://img.shields.io/github/stars/exo-explore/exo?style=social) - Run frontier AI locally by connecting all your devices into a distributed AI cluster. Features automatic device discovery, RDMA over Thunderbolt, tensor parallelism, and topology-aware auto-parallelization. Supports OpenAI, Claude, and Ollama APIs. Apache 2.0 licensed.
...
- **[mistral-finetune](https://github.com/mistralai/mistral-finetune)** ![GitHub stars](https://img.shields.io/github/stars/mistralai/mistral-finetune?style=social) - Official Mistral LoRA fine-tuning codebase. Memory-efficient and performant fine-tuning for Mistral models with multi-GPU-single-node support. Simple, guided entrypoint optimized for Mistral model architecture. Apache 2.0 licensed.
- **[ART (Agent Reinforcement Trainer)](https://github.com/OpenPipe/ART)** ![GitHub stars](https://img.shields.io/github/stars/OpenPipe/ART?style=social) - Train multi-step agents for real-world tasks using GRPO. Give your agents on-the-job training with reinforcement learning for Qwen3.5, GPT-OSS, Llama, and more. Apache 2.0 licensed.
...
- **[Determined AI](https://github.com/determined-ai/determined)** ![GitHub stars](https://img.shields.io/github/stars/determined-ai/determined?style=social) - Open-source machine learning platform that simplifies distributed training, hyperparameter tuning, experiment tracking, and resource management. Works with PyTorch and TensorFlow. Apache 2.0 licensed.
- **[Pachyderm](https://github.com/pachyderm/pachyderm)** ![GitHub stars](https://img.shields.io/github/stars/pachyderm/pachyderm?style=social) - Data-centric pipelines and data versioning for MLOps. Immutable data lineage with automated pipeline triggering on data changes. Scalable data processing for ML workflows. Apache 2.0 licensed.
- **[CML](https://github.com/iterative/cml)** ![GitHub stars](https://img.shields.io/github/stars/iterative/cml?style=social) - Continuous Machine Learning - CI/CD for ML. Automates model training, evaluation, and reporting in Git workflows with cloud GPU runner support. Apache 2.0 licensed.
