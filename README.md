...
- **[SuperAGI](https://github.com/TransformerOptimus/SuperAGI)** ![GitHub stars](https://img.shields.io/github/stars/TransformerOptimus/SuperAGI?style=social) - Dev-first open-source autonomous AI agent framework. Enables developers to build, manage, and run useful autonomous agents quickly and reliably with concurrent agent execution and extensible tool capabilities. MIT licensed.
...
- **[Cognee](https://github.com/topoteretes/cognee)** ![GitHub stars](https://img.shields.io/github/stars/topoteretes/cognee?style=social) - Knowledge engine for AI agent memory combining vector search, graph databases, and cognitive science approaches. Makes documents searchable by meaning and connected by relationships. Apache 2.0 licensed.
- **[Memvid](https://github.com/memvid/memvid)** ![GitHub stars](https://img.shields.io/github/stars/memvid/memvid?style=social) - Single-file memory layer for AI agents with instant retrieval. Packages data, embeddings, search structure, and metadata into one portable file - no server or complex RAG pipelines needed. Apache 2.0 licensed.
- **[USearch (Unum)](https://github.com/unum-cloud/usearch)** ![GitHub stars](https://img.shields.io/github/stars/unum-cloud/usearch?style=social) - Fast open-source search and clustering engine for vectors and arbitrary objects. Smaller and faster than FAISS with broad language support (C++, Python, JavaScript, Rust, Java, Go, and more). Apache 2.0 licensed.
...
- **[Chainlit](https://github.com/Chainlit/chainlit)** ![GitHub stars](https://img.shields.io/github/stars/Chainlit/chainlit?style=social) - Python framework for building production-ready conversational AI interfaces. Create ChatGPT-like UIs with built-in authentication, multi-step workflows, and data persistence. Apache 2.0 licensed.
